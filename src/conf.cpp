...
void ParseArgv(int argc, const char *const argv[]) {
  ...
  hidden_desc.add_options()(
      "directory,d", value<std::vector<std::string>>(&conf->dirs)->composing(),
  ...
  desc.add_options()("help,h", "produce help message")(
      ...
      "skip_renames,w", bool_switch(&conf->skip_renames)->default_value(false),
      ...
      "be verbose")("concurrency,j",
                    value<int>(&conf->concurrency)->default_value(4),
